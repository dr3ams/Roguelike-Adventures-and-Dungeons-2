...
<item:upgradednetherite:corrupt_upgraded_netherite_horse_armor>.anyDamage().addGlobalAttributeModifier(<attribute:minecraft:generic.movement_speed>, "4453815f-dba0-4554-8a5a-ad7c3c8b76123", "Corrupted Horse Armor Speed Boost", 1.4, MULTIPLY_BASE, [<equipmentslottype:chest>]);
<item:upgradednetherite:corrupt_upgraded_netherite_horse_armor>.anyDamage().addGlobalAttributeModifier(<attribute:forge:entity_gravity>, "d3c32fdb-e4db-4fde-83b8-c3b6eaa42fb0", "Corrupted Horse Armor Land Speeder", 0.7, MULTIPLY_BASE, [<equipmentslottype:chest>]);
