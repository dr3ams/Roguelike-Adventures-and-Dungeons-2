...
public class contributors_constants {
	...
	public static val patreonUsers as string[] = ["Kruscle", "Emsiron", "Shadow_Demon_Fox", "curleyc", "Ezekiel_Mag", "CheerierBird61", "S_naptrap", "AnnLS", "DadWorksForSega", "Crankonator"];
	public static val tester as string[] = ["AnnLS", "Crankonator", "xxAero", "Gunner76th"];
}
