...
tellraw @s [{"text":"- Loot chests unopened by any player have a 4% to turn into a mimic. The chance increases up to 5% the further away you are from the chest.","color":"red"}]
...
tellraw @s [{"text":"- The ender dragon will call for backup during the fight.","color":"red"}]
