...
event.remove({output: 'mysticalworld:copper_knife'})
event.remove({output: 'mysticalworld:lead_knife'})
event.remove({output: 'mysticalworld:tin_knife'})
...
event.remove({output: 'mysticalworld:silver_knife'})
...
event.remove({output: 'tropicraft:azurite_ore'})
event.remove({output: 'tropicraft:eudialyte_ore'})
event.remove({output: 'tropicraft:manganese_ore'})
event.remove({output: 'tropicraft:shaka_ore'})
event.remove({output: 'tropicraft:zircon_ore'})
